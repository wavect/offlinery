...
export type NotificationNavigateUserDTOScreenEnum = typeof NotificationNavigateUserDTOScreenEnum[keyof typeof NotificationNavigateUserDTOScreenEnum];


/**
 * Check if a given object implements the NotificationNavigateUserDTO interface.
 */
export function instanceOfNotificationNavigateUserDTO(value: object): value is NotificationNavigateUserDTO {
    if (!('screen' in value) || value['screen'] === undefined) return false;
    if (!('navigateToPerson' in value) || value['navigateToPerson'] === undefined) return false;
    return true;
}

export function NotificationNavigateUserDTOFromJSON(json: any): NotificationNavigateUserDTO {
    return NotificationNavigateUserDTOFromJSONTyped(json, false);
}

export function NotificationNavigateUserDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationNavigateUserDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function NotificationNavigateUserDTOToJSON(value?: NotificationNavigateUserDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
