...
export type EncounterStatusEnum = typeof EncounterStatusEnum[keyof typeof EncounterStatusEnum];
...
export function instanceOfEncounter(value: object): value is Encounter {
    ...
    if (!('lastLongitudePassedBy' in value) || value['lastLongitudePassedBy'] === undefined) return false;
    if (!('lastLatitudePassedBy' in value) || value['lastLatitudePassedBy'] === undefined) return false;
    if (!('users' in value) || value['users'] === undefined) return false;
    if (!('userReports' in value) || value['userReports'] === undefined) return false;
    return true;
}
