...
export type UserGenderDesireEnum =
    (typeof UserGenderDesireEnum)[keyof typeof UserGenderDesireEnum];
...
export type UserVerificationStatusEnum =
    (typeof UserVerificationStatusEnum)[keyof typeof UserVerificationStatusEnum];
...
export type UserApproachChoiceEnum =
    (typeof UserApproachChoiceEnum)[keyof typeof UserApproachChoiceEnum];
...
export function instanceOfUser(value: object): value is User {
    ...
    if (!("passwordHash" in value) || value["passwordHash"] === undefined)
        return false;
    if (!("passwordSalt" in value) || value["passwordSalt"] === undefined)
        return false;
    ...
    if (!("pushToken" in value) || value["pushToken"] === undefined)
        return false;
    if (!("receivedReports" in value) || value["receivedReports"] === undefined)
        return false;
    if (!("issuedReports" in value) || value["issuedReports"] === undefined)
        return false;
...
export function UserFromJSONTyped(
    ...
    return {
        ...
        issuedReports: (json["issuedReports"] as Array<any>).map(
            UserReportFromJSON,
        ),
...
export function UserToJSON(value?: User | null): any {
    ...
    return {
        ...
        issuedReports: (value["issuedReports"] as Array<any>).map(
            UserReportToJSON,
        ),
