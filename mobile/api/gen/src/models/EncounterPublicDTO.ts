...
export type EncounterPublicDTOStatusEnum = typeof EncounterPublicDTOStatusEnum[keyof typeof EncounterPublicDTOStatusEnum];


/**
 * Check if a given object implements the EncounterPublicDTO interface.
 */
export function instanceOfEncounterPublicDTO(value: object): value is EncounterPublicDTO {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('lastDateTimePassedBy' in value) || value['lastDateTimePassedBy'] === undefined) return false;
...
export function EncounterPublicDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncounterPublicDTO {
    if (json == null) {
        return json;
    }
    return {
        ...
        'lastLocationPassedBy': json['lastLocationPassedBy'] == null ? undefined : json['lastLocationPassedBy'],
        'reported': json['reported'],
        'users': ((json['users'] as Array<any>).map(UserPublicDTOFromJSON)),
    };
}

export function EncounterPublicDTOToJSON(value?: EncounterPublicDTO | null): any {
    if (value == null) {
        return value;
    }
    return {
